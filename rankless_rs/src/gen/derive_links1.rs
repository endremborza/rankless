...
impl Entity for WorksCiting { type T = Box<[u32]>; const N: usize = 73722864; const NAME: & str = "works-citing"; }
...
impl Entity for SourceWorks { type T = Box<[u32]>; const N: usize = 39454; const NAME: & str = "source-works"; }
...
impl Entity for WorkSubfields { type T = Box<[u8]>; const N: usize = 73722864; const NAME: & str = "work-subfields"; }
...
impl Entity for WorkAuthors { type T = Box<[u32]>; const N: usize = 73722864; const NAME: & str = "work-authors"; }
...
impl Entity for WorkInstitutions { type T = Box<[u16]>; const N: usize = 73722864; const NAME: & str = "work-institutions"; }
