...
impl Entity for SourceWorks { type T = Box<[u32]>; const N: usize = 40060; const NAME: & str = "source-works"; }
...
impl Entity for WorkSubfields { type T = Box<[u8]>; const N: usize = 75090099; const NAME: & str = "work-subfields"; }
