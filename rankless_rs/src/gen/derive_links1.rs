...
impl Entity for WorksCiting { type T = Box<[u32]>; const N: usize = 78324803; const NAME: & str = "works-citing"; }
...
impl Entity for SourceWorks { type T = Box<[u32]>; const N: usize = 40734; const NAME: & str = "source-works"; }
...
impl Entity for WorkSubfields { type T = Box<[u8]>; const N: usize = 78324803; const NAME: & str = "work-subfields"; }
...
impl Entity for WorkFilteredAuthors { type T = Box<[u32]>; const N: usize = 78324803; const NAME: & str = "work-filtered-authors"; }
...
impl Entity for WorkInstitutions { type T = Box<[u16]>; const N: usize = 78324803; const NAME: & str = "work-institutions"; }
