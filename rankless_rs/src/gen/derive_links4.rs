...
impl VariableSizeAttribute for SubfieldsHits { type SizeType = u8; }
...
impl VariableSizeAttribute for TopicsHits { type SizeType = u8; }
...
impl VariableSizeAttribute for InstitutionsHits { type SizeType = u8; }
