...
impl Entity for SourcesTopPaperAuthors { type T = [(u32, u32); 25]; const N: usize = 39668; const NAME: & str = "sources-top-paper-authors"; }
...
impl Entity for InstitutionsTopPaperAuthors { type T = [(u32, u32); 25]; const N: usize = 30057; const NAME: & str = "institutions-top-paper-authors"; }
...
impl Entity for AuthorsTopPaperAuthors { type T = [(u32, u32); 25]; const N: usize = 3973688; const NAME: & str = "authors-top-paper-authors"; }
