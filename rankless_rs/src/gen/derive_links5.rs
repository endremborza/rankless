...
impl Entity for SourcesCitSubfields { type T = [u32; 253]; const N: usize = 40769; const NAME: & str = "sources-cit-subfields"; }
...
impl Entity for SourcesRefSubfields { type T = [u32; 253]; const N: usize = 40769; const NAME: & str = "sources-ref-subfields"; }
...
impl Entity for SourcesRelInsts { type T = [crate::steps::derive_links5::InstRelation; 8]; const N: usize = 40769; const NAME: & str = "sources-rel-insts"; }
...
impl Entity for HitPapersEra { type T = [u32; 11]; const N: usize = 77953; const NAME: & str = "hit-papers-era"; }
...
impl Entity for HitPaperYearlyCitations { type T = Box<[u32]>; const N: usize = 77953; const NAME: & str = "hit-paper-yearly-citations"; }
...
impl Entity for CountriesRelInsts { type T = [crate::steps::derive_links5::InstRelation; 8]; const N: usize = 233; const NAME: & str = "countries-rel-insts"; }
...
impl Entity for InstitutionsCitSubfields { type T = [u32; 253]; const N: usize = 31861; const NAME: & str = "institutions-cit-subfields"; }
...
impl Entity for InstitutionsRefSubfields { type T = [u32; 253]; const N: usize = 31861; const NAME: & str = "institutions-ref-subfields"; }
...
impl Entity for InstitutionsRelInsts { type T = [crate::steps::derive_links5::InstRelation; 8]; const N: usize = 31861; const NAME: & str = "institutions-rel-insts"; }
...
impl Entity for AuthorsCitSubfields { type T = [u16; 253]; const N: usize = 4156381; const NAME: & str = "authors-cit-subfields"; }
...
impl Entity for AuthorsRefSubfields { type T = [u16; 253]; const N: usize = 4156381; const NAME: & str = "authors-ref-subfields"; }
...
impl Entity for AuthorsRelInsts { type T = [crate::steps::derive_links5::InstRelation; 8]; const N: usize = 4156381; const NAME: & str = "authors-rel-insts"; }
