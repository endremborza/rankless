...
impl Entity for SourcesCiteCount { type T = u32; const N: usize = 2958; const NAME: & str = "sources-cite-count"; }
...
impl Entity for SourcesCitSubfields { type T = [u32; 253]; const N: usize = 2958; const NAME: & str = "sources-cit-subfields"; }
...
impl Entity for SourcesRefSubfields { type T = [u32; 253]; const N: usize = 2958; const NAME: & str = "sources-ref-subfields"; }
...
impl Entity for SourcesPapersYearly { type T = [u32; 11]; const N: usize = 2958; const NAME: & str = "sources-papers-yearly"; }
...
impl Entity for SourcesCitationsYearly { type T = [u32; 11]; const N: usize = 2958; const NAME: & str = "sources-citations-yearly"; }
...
impl Entity for SourcesTopPaperSubfields { type T = [(u32, u8); 3]; const N: usize = 2958; const NAME: & str = "sources-top-paper-subfields"; }
...
impl Entity for SourcesTopCitingSubfields { type T = [(u32, u8); 3]; const N: usize = 2958; const NAME: & str = "sources-top-citing-subfields"; }
...
impl Entity for SourcesTopPaperTopics { type T = [(u32, u16); 3]; const N: usize = 2958; const NAME: & str = "sources-top-paper-topics"; }
...
impl Entity for SourcesTopPaperAuthors { type T = [(u32, u16); 5]; const N: usize = 2958; const NAME: & str = "sources-top-paper-authors"; }
...
impl Entity for SourcesTopJournals { type T = [(u32, u16); 3]; const N: usize = 2958; const NAME: & str = "sources-top-journals"; }
...
impl Entity for SourcesTopAffCountries { type T = [(u32, u8); 3]; const N: usize = 2958; const NAME: & str = "sources-top-aff-countries"; }
...
impl Entity for SourcesRelInsts { type T = [crate::steps::derive_links5::InstRelation; 8]; const N: usize = 2958; const NAME: & str = "sources-rel-insts"; }
...
impl Entity for SourceStats { type T = ([u32; 2], u8); const N: usize = 2958; const NAME: & str = "source-stats"; }
...
impl Entity for HitPapersEra { type T = [u32; 11]; const N: usize = 629; const NAME: & str = "hit-papers-era"; }
...
impl Entity for HitPaperYearlyCitations { type T = Box<[u32]>; const N: usize = 629; const NAME: & str = "hit-paper-yearly-citations"; }
...
impl Entity for CountriesCiteCount { type T = u32; const N: usize = 173; const NAME: & str = "countries-cite-count"; }
...
impl Entity for CountriesCitSubfields { type T = [u32; 253]; const N: usize = 173; const NAME: & str = "countries-cit-subfields"; }
...
impl Entity for CountriesRefSubfields { type T = [u32; 253]; const N: usize = 173; const NAME: & str = "countries-ref-subfields"; }
...
impl Entity for CountriesPapersYearly { type T = [u32; 11]; const N: usize = 173; const NAME: & str = "countries-papers-yearly"; }
...
impl Entity for CountriesCitationsYearly { type T = [u32; 11]; const N: usize = 173; const NAME: & str = "countries-citations-yearly"; }
...
impl Entity for CountriesTopPaperSubfields { type T = [(u32, u8); 3]; const N: usize = 173; const NAME: & str = "countries-top-paper-subfields"; }
...
impl Entity for CountriesTopCitingSubfields { type T = [(u32, u8); 3]; const N: usize = 173; const NAME: & str = "countries-top-citing-subfields"; }
...
impl Entity for CountriesTopPaperTopics { type T = [(u32, u16); 3]; const N: usize = 173; const NAME: & str = "countries-top-paper-topics"; }
...
impl Entity for CountriesTopPaperAuthors { type T = [(u32, u16); 5]; const N: usize = 173; const NAME: & str = "countries-top-paper-authors"; }
...
impl MarkedAttribute<crate::common::Top5AuthorMarker> for crate::gen::a1_entity_mapping::Countries { type AttributeEntity = CountriesTopPaperAuthors; }

impl Entity for CountriesTopJournals { type T = [(u32, u16); 3]; const N: usize = 173; const NAME: & str = "countries-top-journals"; }
...
impl Entity for CountriesTopAffCountries { type T = [(u32, u8); 3]; const N: usize = 173; const NAME: & str = "countries-top-aff-countries"; }
...
impl Entity for CountriesRelInsts { type T = [crate::steps::derive_links5::InstRelation; 8]; const N: usize = 173; const NAME: & str = "countries-rel-insts"; }
...
impl Entity for AuthorsSemanticIds { type T = String; const N: usize = 55617; const NAME: & str = "authors-semantic-ids"; }
...
impl Entity for InstitutionsSemanticIds { type T = String; const N: usize = 4645; const NAME: & str = "institutions-semantic-ids"; }
...
impl Entity for SubfieldsCitSubfields { type T = [u16; 253]; const N: usize = 254; const NAME: & str = "subfields-cit-subfields"; }
...
impl Entity for SubfieldsRefSubfields { type T = [u16; 253]; const N: usize = 254; const NAME: & str = "subfields-ref-subfields"; }
...
impl Entity for SubfieldsTopPaperAuthors { type T = [(u32, u16); 5]; const N: usize = 254; const NAME: & str = "subfields-top-paper-authors"; }
...
impl MarkedAttribute<crate::common::Top5AuthorMarker> for crate::gen::a1_entity_mapping::Subfields { type AttributeEntity = SubfieldsTopPaperAuthors; }
...
impl Entity for TopicsCitSubfields { type T = [u16; 253]; const N: usize = 4518; const NAME: & str = "topics-cit-subfields"; }
...
impl Entity for TopicsRefSubfields { type T = [u16; 253]; const N: usize = 4518; const NAME: & str = "topics-ref-subfields"; }
...
impl Entity for TopicsTopPaperAuthors { type T = [(u32, u16); 5]; const N: usize = 4518; const NAME: & str = "topics-top-paper-authors"; }
...
impl MarkedAttribute<crate::common::Top5AuthorMarker> for crate::gen::a1_entity_mapping::Topics { type AttributeEntity = TopicsTopPaperAuthors; }
...
impl Entity for InstitutionsCiteCount { type T = u32; const N: usize = 4645; const NAME: & str = "institutions-cite-count"; }
...
impl Entity for InstitutionsCitSubfields { type T = [u16; 253]; const N: usize = 4645; const NAME: & str = "institutions-cit-subfields"; }
...
impl Entity for InstitutionsRefSubfields { type T = [u16; 253]; const N: usize = 4645; const NAME: & str = "institutions-ref-subfields"; }
...
impl Entity for InstitutionsPapersYearly { type T = [u32; 11]; const N: usize = 4645; const NAME: & str = "institutions-papers-yearly"; }
...
impl Entity for InstitutionsCitationsYearly { type T = [u32; 11]; const N: usize = 4645; const NAME: & str = "institutions-citations-yearly"; }
...
impl Entity for InstitutionsTopPaperSubfields { type T = [(u32, u8); 3]; const N: usize = 4645; const NAME: & str = "institutions-top-paper-subfields"; }
...
impl Entity for InstitutionsTopCitingSubfields { type T = [(u32, u8); 3]; const N: usize = 4645; const NAME: & str = "institutions-top-citing-subfields"; }
...
impl Entity for InstitutionsTopPaperTopics { type T = [(u32, u16); 3]; const N: usize = 4645; const NAME: & str = "institutions-top-paper-topics"; }
...
impl Entity for InstitutionsTopPaperAuthors { type T = [(u32, u16); 5]; const N: usize = 4645; const NAME: & str = "institutions-top-paper-authors"; }
...
impl Entity for InstitutionsTopJournals { type T = [(u32, u16); 3]; const N: usize = 4645; const NAME: & str = "institutions-top-journals"; }
...
impl Entity for InstitutionsTopAffCountries { type T = [(u32, u8); 3]; const N: usize = 4645; const NAME: & str = "institutions-top-aff-countries"; }
...
impl Entity for InstitutionsRelInsts { type T = [crate::steps::derive_links5::InstRelation; 8]; const N: usize = 4645; const NAME: & str = "institutions-rel-insts"; }
...
impl Entity for AuthorsCiteCount { type T = u16; const N: usize = 55617; const NAME: & str = "authors-cite-count"; }
...
impl Entity for AuthorsCitSubfields { type T = [u16; 253]; const N: usize = 55617; const NAME: & str = "authors-cit-subfields"; }
...
impl Entity for AuthorsRefSubfields { type T = [u16; 253]; const N: usize = 55617; const NAME: & str = "authors-ref-subfields"; }
...
impl Entity for AuthorsPapersYearly { type T = [u32; 11]; const N: usize = 55617; const NAME: & str = "authors-papers-yearly"; }
...
impl Entity for AuthorsCitationsYearly { type T = [u32; 11]; const N: usize = 55617; const NAME: & str = "authors-citations-yearly"; }
...
impl Entity for AuthorsTopPaperSubfields { type T = [(u32, u8); 3]; const N: usize = 55617; const NAME: & str = "authors-top-paper-subfields"; }
...
impl Entity for AuthorsTopCitingSubfields { type T = [(u32, u8); 3]; const N: usize = 55617; const NAME: & str = "authors-top-citing-subfields"; }
...
impl Entity for AuthorsTopPaperTopics { type T = [(u32, u16); 3]; const N: usize = 55617; const NAME: & str = "authors-top-paper-topics"; }
...
impl Entity for AuthorsTopPaperAuthors { type T = [(u32, u16); 5]; const N: usize = 55617; const NAME: & str = "authors-top-paper-authors"; }
...
impl Entity for AuthorsTopJournals { type T = [(u32, u16); 3]; const N: usize = 55617; const NAME: & str = "authors-top-journals"; }
...
impl Entity for AuthorsTopAffCountries { type T = [(u32, u8); 3]; const N: usize = 55617; const NAME: & str = "authors-top-aff-countries"; }
...
impl Entity for AuthorsRelInsts { type T = [crate::steps::derive_links5::InstRelation; 8]; const N: usize = 55617; const NAME: & str = "authors-rel-insts"; }
...
impl Entity for SourcePairsByPath { type T = ([u16; 2], u32); const N: usize = 800799; const NAME: & str = "source-pairs-by-path"; }
...
impl Entity for SubfieldPairsByPath { type T = ([u8; 2], u32); const N: usize = 24008; const NAME: & str = "subfield-pairs-by-path"; }
