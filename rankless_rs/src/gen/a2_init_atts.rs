...
pub struct FilteredAuthorshipPosition {}

pub struct SourceAreaFields {}

pub struct CountriesNames {}

pub struct DiscardedAuthorshipPosition {}
...
impl Entity for AuthorshipFilteredAuthor {
    type T = u32;
    const N: usize = 212976067;
    const NAME: &str = "authorship-filtered-author";
}

impl MappableEntity for AuthorshipFilteredAuthor {
    type KeyType = usize;
}

impl NamespacedEntity for AuthorshipFilteredAuthor {
    const NS: &str = "a2_init_atts";
}

impl Entity for AuthorshipDiscardedAuthor {
    type T = u32;
    const N: usize = 124783763;
    const NAME: &str = "authorship-discarded-author";
}

impl MappableEntity for AuthorshipDiscardedAuthor {
    type KeyType = usize;
}

impl NamespacedEntity for AuthorshipDiscardedAuthor {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for FilteredAuthorshipInstitutions {
    type KeyType = usize;
}

impl VariableSizeAttribute for FilteredAuthorshipInstitutions {
    type SizeType = u8;
    type LocType = u32;
}

impl NamespacedEntity for FilteredAuthorshipInstitutions {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for DiscardedAuthorshipInstitutions {
    type KeyType = usize;
}

impl VariableSizeAttribute for DiscardedAuthorshipInstitutions {
    type SizeType = u8;
    type LocType = u32;
}

impl NamespacedEntity for DiscardedAuthorshipInstitutions {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for FilteredAuthorshipPosition {
    type KeyType = usize;
}

impl NamespacedEntity for FilteredAuthorshipPosition {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for DiscardedAuthorshipPosition {
    type KeyType = usize;
}

impl NamespacedEntity for DiscardedAuthorshipPosition {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for WorkAnyAuthorships {
    type KeyType = usize;
}

impl VariableSizeAttribute for WorkAnyAuthorships {
    type SizeType = u16;
    type LocType = u32;
}

impl NamespacedEntity for WorkAnyAuthorships {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for WorkBiblios {
    type KeyType = usize;
}

impl VariableSizeAttribute for WorkBiblios {
    type SizeType = u8;
    type LocType = u32;
}

impl NamespacedEntity for WorkBiblios {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for WorkDois {
    type KeyType = usize;
}

impl VariableSizeAttribute for WorkDois {
    type SizeType = u16;
    type LocType = u32;
}

impl NamespacedEntity for WorkDois {
    const NS: &str = "a2_init_atts";
}

impl MarkedAttribute<crate::common::DoiMarker> for crate::gen::a1_entity_mapping::Works {
    type AttributeEntity = WorkDois;
}

impl Entity for DomainsNames {
    type T = String;
    const N: usize = 6;
    const NAME: &str = "domains-names";
}

impl MappableEntity for DomainsNames {
    type KeyType = usize;
}

impl VariableSizeAttribute for DomainsNames {
    type SizeType = u8;
    type LocType = u8;
}

impl NamespacedEntity for DomainsNames {
    const NS: &str = "a2_init_atts";
}

impl MarkedAttribute<crate::common::NameMarker> for crate::gen::a1_entity_mapping::Domains {
    type AttributeEntity = DomainsNames;
}
...
impl MappableEntity for CitiesNames {
    type KeyType = usize;
}

impl VariableSizeAttribute for CitiesNames {
    type SizeType = u8;
    type LocType = u32;
}

impl NamespacedEntity for CitiesNames {
    const NS: &str = "a2_init_atts";
}

impl MarkedAttribute<crate::common::NameMarker> for crate::gen::a1_entity_mapping::Cities {
    type AttributeEntity = CitiesNames;
}
...
impl MappableEntity for CountryCodes {
    type KeyType = usize;
}

impl NamespacedEntity for CountryCodes {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for CountryCodesThree {
    type KeyType = usize;
}

impl NamespacedEntity for CountryCodesThree {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for InstLocs {
    type KeyType = usize;
}

impl NamespacedEntity for InstLocs {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for InstRors {
    type KeyType = usize;
}

impl NamespacedEntity for InstRors {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for InstCities {
    type KeyType = usize;
}

impl NamespacedEntity for InstCities {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for DiscardedAuthorsNames {
    type KeyType = usize;
}

impl VariableSizeAttribute for DiscardedAuthorsNames {
    type SizeType = u16;
    type LocType = u32;
}

impl NamespacedEntity for DiscardedAuthorsNames {
    const NS: &str = "a2_init_atts";
}

impl MarkedAttribute<crate::common::NameMarker>
    for crate::gen::a1_entity_mapping::DiscardedAuthors
{
    type AttributeEntity = DiscardedAuthorsNames;
}
...
impl MappableEntity for AuthorWikiSlugs {
    type KeyType = usize;
}

impl VariableSizeAttribute for AuthorWikiSlugs {
    type SizeType = u8;
    type LocType = u16;
}

impl NamespacedEntity for AuthorWikiSlugs {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for AuthorOrcids {
    type KeyType = usize;
}

impl NamespacedEntity for AuthorOrcids {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for AuthorRawCites {
    type KeyType = usize;
}

impl NamespacedEntity for AuthorRawCites {
    const NS: &str = "a2_init_atts";
}
...
impl MappableEntity for AuthorRawWorkCounts {
    type KeyType = usize;
}

impl NamespacedEntity for AuthorRawWorkCounts {
    const NS: &str = "a2_init_atts";
}
...
impl Entity for SubfieldsWikipedia {
    type T = String;
    const N: usize = 254;
    const NAME: &str = "subfields-wikipedia";
}

impl MappableEntity for SubfieldsWikipedia {
    type KeyType = usize;
}

impl VariableSizeAttribute for SubfieldsWikipedia {
    type SizeType = u8;
    type LocType = u16;
}

impl NamespacedEntity for SubfieldsWikipedia {
    const NS: &str = "a2_init_atts";
}

impl Entity for TopicsWikipedia {
    type T = String;
    const N: usize = 4518;
    const NAME: &str = "topics-wikipedia";
}

impl MappableEntity for TopicsWikipedia {
    type KeyType = usize;
}

impl VariableSizeAttribute for TopicsWikipedia {
    type SizeType = u8;
    type LocType = u32;
}

impl NamespacedEntity for TopicsWikipedia {
    const NS: &str = "a2_init_atts";
}
...
impl Entity for FieldAncestors {
    type T = u8;
    const N: usize = 28;
    const NAME: &str = "field-ancestors";
}

impl MappableEntity for FieldAncestors {
    type KeyType = usize;
}

impl NamespacedEntity for FieldAncestors {
    const NS: &str = "a2_init_atts";
}
