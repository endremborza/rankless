...
impl Entity for AuthorshipFilteredAuthor { type T = u32; const N: usize = 196761332; const NAME: & str = "authorship-filtered-author"; }
...
impl Entity for AuthorshipDiscardedAuthor { type T = u32; const N: usize = 103498269; const NAME: & str = "authorship-discarded-author"; }
...
impl Entity for FilteredAuthorshipInstitutions { type T = Box<[u16]>; const N: usize = 196761332; const NAME: & str = "filtered-authorship-institutions"; }
...
impl Entity for DiscardedAuthorshipInstitutions { type T = Box<[u16]>; const N: usize = 103498269; const NAME: & str = "discarded-authorship-institutions"; }
...
impl Entity for WorkAnyAuthorships { type T = Box<[u32]>; const N: usize = 78607024; const NAME: & str = "work-any-authorships"; }
...
impl Entity for WorkBiblios { type T = crate::biblo_var_att::BiblioInfo; const N: usize = 78607024; const NAME: & str = "work-biblios"; }
...
impl Entity for WorkYears { type T = u8; const N: usize = 78607024; const NAME: & str = "work-years"; }
...
impl Entity for WorksNames { type T = String; const N: usize = 78607024; const NAME: & str = "works-names"; }
...
impl Entity for WorkDois { type T = String; const N: usize = 78607024; const NAME: & str = "work-dois"; }
...
impl Entity for InstitutionsNames { type T = String; const N: usize = 33245; const NAME: & str = "institutions-names"; }
...
impl Entity for InstLocs { type T = (f64, f64); const N: usize = 33245; const NAME: & str = "inst-locs"; }

impl MappableEntity for InstLocs { type KeyType = usize; }

impl NamespacedEntity for InstLocs { const NS: & str = "a2_init_atts"; }

impl Entity for InstRors { type T = [u8; 9]; const N: usize = 33245; const NAME: & str = "inst-rors"; }

impl MappableEntity for InstRors { type KeyType = usize; }

impl NamespacedEntity for InstRors { const NS: & str = "a2_init_atts"; }

impl Entity for InstCities { type T = u16; const N: usize = 33245; const NAME: & str = "inst-cities"; }
...
impl Entity for DiscardedAuthorsNames { type T = String; const N: usize = 105519236; const NAME: & str = "discarded-authors-names"; }
...
impl Entity for AuthorsNames { type T = String; const N: usize = 4175973; const NAME: & str = "authors-names"; }
...
impl Entity for AuthorWikiSlugs { type T = String; const N: usize = 4175973; const NAME: & str = "author-wiki-slugs"; }
...
impl Entity for AuthorOrcids { type T = [u8; 19]; const N: usize = 4175973; const NAME: & str = "author-orcids"; }

impl MappableEntity for AuthorOrcids { type KeyType = usize; }

impl NamespacedEntity for AuthorOrcids { const NS: & str = "a2_init_atts"; }

impl Entity for AuthorRawCites { type T = u32; const N: usize = 4175973; const NAME: & str = "author-raw-cites"; }
...
impl Entity for AuthorRawWorkCounts { type T = u32; const N: usize = 4175973; const NAME: & str = "author-raw-work-counts"; }
...
impl Entity for SourcesNameExts { type T = String; const N: usize = 41067; const NAME: & str = "sources-name-exts"; }
...
impl Entity for SourceAreaFields { type T = Box<[u8]>; const N: usize = 41067; const NAME: & str = "source-area-fields"; }
...
impl Entity for WorkTopics { type T = Box<[u16]>; const N: usize = 78607024; const NAME: & str = "work-topics"; }
