...
impl Entity for WorkCitingCounts { type T = u32; const N: usize = 78324803; const NAME: & str = "work-citing-counts"; }
...
impl Entity for WorkTopSource { type T = u16; const N: usize = 78324803; const NAME: & str = "work-top-source"; }
...
impl Entity for AuthorWorks { type T = Box<[u32]>; const N: usize = 4143928; const NAME: & str = "author-works"; }
...
impl Entity for InstitutionWorks { type T = Box<[u32]>; const N: usize = 31616; const NAME: & str = "institution-works"; }
...
impl Entity for WorkCountries { type T = Box<[u8]>; const N: usize = 78324803; const NAME: & str = "work-countries"; }
