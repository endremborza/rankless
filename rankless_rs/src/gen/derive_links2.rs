...
impl Entity for SourcesCiteCount { type T = u32; const N: usize = 41067; const NAME: & str = "sources-cite-count"; }
...
impl Entity for SourcesCitSubfields { type T = [usize; 253]; const N: usize = 41067; const NAME: & str = "sources-cit-subfields"; }
...
impl Entity for SourcesRefSubfields { type T = [usize; 253]; const N: usize = 41067; const NAME: & str = "sources-ref-subfields"; }
...
impl Entity for SourcesPapersYearly { type T = [u32; 11]; const N: usize = 41067; const NAME: & str = "sources-papers-yearly"; }
...
impl Entity for SourcesCitationsYearly { type T = [u32; 11]; const N: usize = 41067; const NAME: & str = "sources-citations-yearly"; }
...
impl Entity for SourcesTopPaperSubfields { type T = [(u32, u8); 3]; const N: usize = 41067; const NAME: & str = "sources-top-paper-subfields"; }
...
impl Entity for SourcesTopCitingSubfields { type T = [(u32, u8); 3]; const N: usize = 41067; const NAME: & str = "sources-top-citing-subfields"; }
...
impl Entity for SourcesTopPaperTopics { type T = [(u32, u16); 3]; const N: usize = 41067; const NAME: & str = "sources-top-paper-topics"; }
...
impl Entity for SourcesTopPaperAuthors { type T = [(u32, u32); 25]; const N: usize = 41067; const NAME: & str = "sources-top-paper-authors"; }
...
impl Entity for SourcesTopJournals { type T = [(u32, u16); 3]; const N: usize = 41067; const NAME: & str = "sources-top-journals"; }
...
impl Entity for SourcesTopAffCountries { type T = [(u32, u8); 3]; const N: usize = 41067; const NAME: & str = "sources-top-aff-countries"; }
...
impl Entity for SourcesRelInsts { type T = [crate::steps::derive_links2::InstRelation; 8]; const N: usize = 41067; const NAME: & str = "sources-rel-insts"; }
...
impl Entity for SourceStats { type T = ([u32; 2], u8); const N: usize = 41067; const NAME: & str = "source-stats"; }
...
impl Entity for InstitutionsCiteCount { type T = u32; const N: usize = 33245; const NAME: & str = "institutions-cite-count"; }
...
impl Entity for InstitutionsCitSubfields { type T = [usize; 253]; const N: usize = 33245; const NAME: & str = "institutions-cit-subfields"; }
...
impl Entity for InstitutionsRefSubfields { type T = [usize; 253]; const N: usize = 33245; const NAME: & str = "institutions-ref-subfields"; }
...
impl Entity for InstitutionsPapersYearly { type T = [u32; 11]; const N: usize = 33245; const NAME: & str = "institutions-papers-yearly"; }
...
impl Entity for InstitutionsCitationsYearly { type T = [u32; 11]; const N: usize = 33245; const NAME: & str = "institutions-citations-yearly"; }
...
impl Entity for InstitutionsTopPaperSubfields { type T = [(u32, u8); 3]; const N: usize = 33245; const NAME: & str = "institutions-top-paper-subfields"; }
...
impl Entity for InstitutionsTopCitingSubfields { type T = [(u32, u8); 3]; const N: usize = 33245; const NAME: & str = "institutions-top-citing-subfields"; }
...
impl Entity for InstitutionsTopPaperTopics { type T = [(u32, u16); 3]; const N: usize = 33245; const NAME: & str = "institutions-top-paper-topics"; }
...
impl Entity for InstitutionsTopPaperAuthors { type T = [(u32, u32); 25]; const N: usize = 33245; const NAME: & str = "institutions-top-paper-authors"; }
...
impl Entity for InstitutionsTopJournals { type T = [(u32, u16); 3]; const N: usize = 33245; const NAME: & str = "institutions-top-journals"; }
...
impl Entity for InstitutionsTopAffCountries { type T = [(u32, u8); 3]; const N: usize = 33245; const NAME: & str = "institutions-top-aff-countries"; }
...
impl Entity for InstitutionsRelInsts { type T = [crate::steps::derive_links2::InstRelation; 8]; const N: usize = 33245; const NAME: & str = "institutions-rel-insts"; }
...
impl Entity for AuthorsCiteCount { type T = u32; const N: usize = 4175973; const NAME: & str = "authors-cite-count"; }
...
impl Entity for AuthorsCitSubfields { type T = [usize; 253]; const N: usize = 4175973; const NAME: & str = "authors-cit-subfields"; }
...
impl Entity for AuthorsRefSubfields { type T = [usize; 253]; const N: usize = 4175973; const NAME: & str = "authors-ref-subfields"; }
...
impl Entity for AuthorsPapersYearly { type T = [u32; 11]; const N: usize = 4175973; const NAME: & str = "authors-papers-yearly"; }
...
impl Entity for AuthorsCitationsYearly { type T = [u32; 11]; const N: usize = 4175973; const NAME: & str = "authors-citations-yearly"; }
...
impl Entity for AuthorsTopPaperSubfields { type T = [(u32, u8); 3]; const N: usize = 4175973; const NAME: & str = "authors-top-paper-subfields"; }
...
impl Entity for AuthorsTopCitingSubfields { type T = [(u32, u8); 3]; const N: usize = 4175973; const NAME: & str = "authors-top-citing-subfields"; }
...
impl Entity for AuthorsTopPaperTopics { type T = [(u32, u16); 3]; const N: usize = 4175973; const NAME: & str = "authors-top-paper-topics"; }
...
impl Entity for AuthorsTopPaperAuthors { type T = [(u32, u32); 25]; const N: usize = 4175973; const NAME: & str = "authors-top-paper-authors"; }
...
impl Entity for AuthorsTopJournals { type T = [(u32, u16); 3]; const N: usize = 4175973; const NAME: & str = "authors-top-journals"; }
...
impl Entity for AuthorsTopAffCountries { type T = [(u32, u8); 3]; const N: usize = 4175973; const NAME: & str = "authors-top-aff-countries"; }
...
impl Entity for AuthorsRelInsts { type T = [crate::steps::derive_links2::InstRelation; 8]; const N: usize = 4175973; const NAME: & str = "authors-rel-insts"; }
...
impl Entity for SourcePairsByPath { type T = ([u16; 2], u32); const N: usize = 155962981; const NAME: & str = "source-pairs-by-path"; }
...
impl Entity for WorkCitingCounts { type T = u32; const N: usize = 78607024; const NAME: & str = "work-citing-counts"; }
...
impl Entity for AuthorWorks { type T = Box<[u32]>; const N: usize = 4175973; const NAME: & str = "author-works"; }
...
impl Entity for InstitutionWorks { type T = Box<[u32]>; const N: usize = 33245; const NAME: & str = "institution-works"; }
...
impl Entity for WorkCountries { type T = Box<[u8]>; const N: usize = 78607024; const NAME: & str = "work-countries"; }
...
impl Entity for WorkTopSource { type T = u16; const N: usize = 78607024; const NAME: & str = "work-top-source"; }
