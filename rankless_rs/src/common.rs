...
pub struct TopNPaperSfMarker;
pub struct TopNCitingSfMarker;
pub struct TopNPaperTopicMarker;
pub struct Top15AuthorMarker;
pub struct TopNCitingTopicMarker;
pub struct TopJournalMarker;
pub struct Top3AffCountryMarker;
pub struct PeerMarker;
pub struct HIndexMarker;
pub struct HIndexSinceMarker;
pub struct ScoredPaperCountMarker;
pub struct WeightedPaperScoreMarker;
pub struct TopMeanPaperScoreMarker;
