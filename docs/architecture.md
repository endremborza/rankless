...
| `migrate_revoke_targets.py`                                                     | One-time: rewrite legacy `revoke` payloads from `target_event_id` → `target_key` (run once on the source DB)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `migrate_claim_merges.py`                                                       | One-time: convert claim merge-candidates (claimed DOI OA-attributed to a name-matching other record) into admin-confirmed accepted `merge_authors` events, per-candidate y/n                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
