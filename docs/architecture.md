...
**Deployment (`pyscripts/release.py` → `deploy.py`):** staged release flow
(`uv run -m pyscripts release <stage>`, see [deploy](deploy.md)) over Linux, systemd
(Rust backend + Bun frontend), Nginx reverse proxy, Let's Encrypt SSL. Live
monitoring via distributed alert swarm (`live_monitoring.py`).
...
| File                                                                            | Role                                                                                                                                                                                                                                                                                                      |
| ------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `__main__.py`                                                                   | Unified CLI for the benchmark family: `uv run -m pyscripts {compare-sql,compare-branch,bench,cache}`; lazy per-command imports                                                                                                                                                                            |
...
| `export_user_ledger.py`                                                         | Exports SQLite ledger → `$OA_ROOT/user-ledger/` snapshot before `filter`; collapses revokes (resolved pairs dropped, unresolved kept with `target_inlined`)                                                                                                                                               |
| `deploy.py`                                                                     | EC2 deployment primitives: Nginx, systemd, SSL, code push, user-DB handoff                                                                                                                                                                                                                                |
| `release.py`                                                                    | Release flow stages (`uv run -m pyscripts release <stage>`, see [deploy](deploy.md))                                                                                                                                                                                                                      |
