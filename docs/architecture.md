...
(`uv run -m pyscripts deploy <stage>`, see [deploy](deploy.md)) over Linux, systemd
...
| `release.py`                                                                    | Release flow stages (`uv run -m pyscripts deploy <stage>`, see [deploy](deploy.md))                                                                                                                                                                                                                       |
